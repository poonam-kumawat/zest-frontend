  ...
  return (
    <div className='w-full h-full min-h-screen home'>
      <section className='max-w-screen-2xl mx-auto'>
        <section className='banner-search mt-4 relative flex items-center justify-center'>
          <img className='bg-cover w-full bg-no-repeat' src="/assets/images/homePage.svg" alt='home' />
          <div className='flex flex-col justify-center items-center absolute top-44 gap-8'>
            <div className='text-6xl text-[#1F2937] font-bold'>Fresh Food that deserve to eat</div>
            <div className='text-xl text-[#1F2937]'>Get your healthy foods & snacks delivered at your doorsteps all day everyday</div>
